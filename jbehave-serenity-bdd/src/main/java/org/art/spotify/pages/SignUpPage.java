...
public class SignUpPage extends PageObject {
    ...
    public SignUpPage setMonth(String month) {
        find(monthDropDown).waitUntilClickable().click();
        String monthDropDownOptions = "//select[@id='month']/option[text()='%s']";
        find(By.xpath(String.format(monthDropDownOptions, month))).waitUntilClickable().click();
        return this;
    }
    ...
    public SignUpPage setSexRadioButton(String gender) {
        findAll(genders).stream()
                        .filter(e -> gender.equals(e.getText()))
                        .findFirst().get().click();
        return this;
    }
}
